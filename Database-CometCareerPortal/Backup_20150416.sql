...
) ENGINE=InnoDB AUTO_INCREMENT=13496 DEFAULT CHARSET=utf8;
...
INSERT INTO `company` VALUES (4003,'Deloitte Consultant Pvt. Ltd ','Deloitte is a leading IT consulting firm which gives technology and business solutions in Healthcare and financial domain.','Dallas','http://www2.deloitte.com/us/en.html','deloitte123','deloitte123'),(13495,'Bank of America','Leading Financial Bank in Dallas Fort-Worth area. ','Dallas, Texas','http://careers.bankofamerica.com/search-jobs.aspx?c=united-s','bofa123','bofa123');
...
INSERT INTO `department` VALUES (1244,'Computer Science','csadmin123','csadmin123');
...
) ENGINE=InnoDB AUTO_INCREMENT=14738 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `employment_details` VALUES (14730,'ACI Worldwide Inc.',2,'Associate Database Administrator',8377),(14731,'TrueSpider Technology',3,'UI Designer',14455),(14732,'The University of Texas at Dallas',5,'Ashbel Smith Professor-Computer Science',8379),(14733,'ACI Worldwide Inc.',4,'Principal Architect',8379),(14734,'TrueSpider Technology',2,'Co-Founder and Chief Technical Officer',14458),(14735,'ORACLE Services ',4,'Software Engineer ',14459),(14736,'TrueSpider Technology',1,'Senior Developer',14454),(14737,'Human Language Technology Research Institute',5,'Co-Director',8376);
...
CREATE TABLE `job` (
  ...
  `description` varchar(1024) DEFAULT NULL,
  `visa_category` varchar(128) DEFAULT NULL,
  `job_type` varchar(255) DEFAULT NULL,
  `status` char(1) DEFAULT NULL,
  `author_id` int(11) NOT NULL,
  `link` varchar(255) DEFAULT NULL,
  `primary_requirement` varchar(64) NOT NULL DEFAULT 'NONE',
  `secondary_requirement` varchar(64) NOT NULL DEFAULT 'NONE',
  `additional_requirement` varchar(64) NOT NULL DEFAULT 'NONE',
  PRIMARY KEY (`job_id`)
...
INSERT INTO `job` VALUES (6813,'Web Developer','Web developer needed for the web-site design of my new research institute.','USCitizen/F1','OnCampus','A',8376,'NULL','HTML','CSS','JavaScript');
...
) ENGINE=InnoDB AUTO_INCREMENT=14711 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `skills` VALUES (1,'Java',3,4,14456),(2,'Java',2,4,14457),(3,'Java',2,4,14458),(4,'Java',1,4,14459),(5,'NLTK',1,3,14454),(6,'NLTK',9,5,8376);
...
INSERT INTO `student` VALUES (14454,'Prasad','Pande','Computer Science','4692303887','pande.prasad1@gmail.com','7825, McCallum BlvdApartment 716DallasTexas75252',NULL,'prasad123','prasad123','Graduate Student'),(14455,'Rahul','Dalia','Computer Science','14692303887','rahul.dalia1@gmail.com','716-Border PL, University OaksApt-3ArlingtonTexas76013',NULL,'rahul123','rahul123','Graduate Student'),(14456,'Varun','Shah','Computer Science','19860241462','14varun@gmail.com','7825, McCallum BlvdApartment 716DallasTexas75252',NULL,'varun123','varun123','Graduate Student'),(14457,'Nishant','Shah','Computer Science','14692305468','nishant.shah@gmail.com','7825, McCallum BlvdApt716DallasTexas75252',NULL,'nishant123','nishant123','PhD Student'),(14458,'abc','abc','Computer Science','123456789','abc@gmail.com','abcabcabcabcabc',NULL,'abc123','abc123','Undergraduate Student'),(14459,'Pawan','Gadewar','Telecommunication Engineering','19860241462','pawan.gadewar@gmail.com','7825, McCallum BlvdApt716TexasDallas75252',NULL,'pawan123','pawan123','PhD Student'),(14460,'Nikhil','Bachhav','Computer Science','19595688392','nikhil.bachhav@gmail.com','716-Border PL, University Oaks Apt-3 Arlington Texas 76013',NULL,'nikhil123','nikhil123','Graduate Student');
...
INSERT INTO `student_projects` VALUES (787,14454,14695),(788,14454,14696),(789,14455,14701),(790,14456,14705),(791,14457,14706),(792,14458,14707),(793,14459,14708),(794,14455,14709),(795,14454,14710);
...
-- Dump completed on 2015-04-16  0:37:08
